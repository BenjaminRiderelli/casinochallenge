...
import jackpotsIcon from "@/assets/icons/rocket.svg";
...
const HeroSection = () => {
  ...
  return (
    <section className="flex flex-col justify-between pt-8 min-h-[calc(100vh-10rem)] md:min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-center px-10 min-h-full pt-4 ">
        <div className="flex flex-col items-center md:items-start gap-8 md:w-2/5">
          ...
          <button className="rounded-md text-lg font-semibold bg-p-btn-color p-3 px-8 cursor-pointer">
            Join now!
          </button>
        </div>
        <Image src={casinoGuy} alt="guy" />
      </div>
      <div className="flex overflow-x-scroll items-center w-full pt-4 text-xl gap-4 px-4 pb-10 no-scrollbar">
